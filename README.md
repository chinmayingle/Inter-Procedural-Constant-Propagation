...
- **assign**: It contains the input IR (Intermediate Representation) code files for public test cases.
- **cons_eval.cpp**: The main implementation file for the constant propagation pass.
